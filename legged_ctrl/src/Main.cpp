...
int main(int argc, char **argv) {
    ...
    std::thread mpc_thread([&]() {
        ...
        while (ros::ok()) {
            ...
            // Solve MPC
            // TODO: Record real dt and pass it to the update function? Will this improve sth?
            mtx.lock();
            ...
            ros::Duration sleep_duration(mpc_update_period / 1000.0 - time_span.count() / 1000.0);
