...
public:
    ...
    void ct_srb_quat_dynamics(double *x_dot, const double *x, const double *u, Eigen::Matrix<double, 3, NUM_LEG> foot_pos_body, Eigen::Matrix3d inertia_body, Eigen::Matrix3d torso_rot_mat) const;

    void ct_srb_quat_jacobian(double *jac, const double *x, const double *u, Eigen::Matrix<double, 3, NUM_LEG> foot_pos_body, Eigen::Matrix3d inertia_body) const;
